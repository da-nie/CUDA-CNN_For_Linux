...
class CCUDACNN
{
 ...
 public:
  ...
  static const size_t CUDA_MAX_INPUT_IMAGE_AMOUNT=85;//количество одновременно обрабатываемых CUDA изображений
  ...
  static const size_t KERNEL_A_AMOUNT=32;//количество ядер первого слоя
  ...
  static const size_t OUTPUT_LAYER_SIZE=10;//размер выходного образа
 public:
  //-переменные-----------------------------------------------------------------------------------------
